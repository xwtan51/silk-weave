...
export default function DetailModal({ pattern, onClose, onColorPattern }: DetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      <div className="bg-paper rounded-3xl max-h-[85vh] w-[92%] max-w-[340px] overflow-y-auto shadow-2xl animate-[zoomIn_0.25s_ease-out] relative mx-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden" onClick={(e) => e.stopPropagation()}>
